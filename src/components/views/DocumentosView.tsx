...
export function DocumentosView() {
  ...
  function renomearPasta(nomeSub: string) {
    if (caminhoAtual === "" && PASTAS_INICIAIS.includes(nomeSub)) {
      setErro(
        "Essa é uma pasta padrão e fica com o nome fixo. Qualquer outra pasta ou subpasta que você criar pode ser renomeada normalmente."
      );
      return;
    }
  ...
  function excluirPasta(nomeSub: string) {
    if (caminhoAtual === "" && PASTAS_INICIAIS.includes(nomeSub)) {
      setErro(
        "Essa é uma pasta padrão e não pode ser excluída. As pastas que você criar podem ser excluídas normalmente."
      );
      return;
    }
